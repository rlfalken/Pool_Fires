...
\begin{threeparttable}
    ...
    \begin{tabular}{c|ccccp{0.3cm}cp{3cm}}
								&$\dot{m''}$~(\si{g/{m^2 s}})		& $\dot{Q}$~(\si{kW})		&  $\chi_r$		& $\chi_{rad}$	& Lip Height&\text{Ref.}				&\text{Comments}					\\ \hline
\multirow{11}{*}{\rotatebox{90}{Methanol}}	        	&	15.1~$\pm$~*		&	21.4				&*			&*		&	10		& \cite{Weckman1996}				&Volumetric Burning Rate of 1.35~\si{cm^3/s}	\\
		            					&	13.5~$\pm$~9\%		&	19.2				&	0.19		&0.24		&	10		&\cite{Kim2019}					&								\\
								&	12.9~$\pm$~*		&	18.3				&	0.22		&*		&	5		&\cite{Hamins1994}				&Fuel Mass Burning Rate of 0.92~g/s			\\	
								&	12.6~$\pm$~*		&	18.0				&	*		&0.20		&	5		&\cite{Klassen1994}				&Fuel Mass Burning Rate of 0.9~g/s 			\\	           								
...
\multirow{4}{*}{\rotatebox{90}{Ethanol}}	        	&	16.2~$\pm$~11\%		&	31.0				&	0.21		&*		&	10		&\cite{Kim2019}					&								\\
	        							&	14.4~$\pm$~10\%		&	27.3				&	0.16		&*		&	5		&\cite{Buch1997}					&								\\
	        							&	13.9~$\pm$~15\%		&	26.3				&	*		&0.26		&	10		&This study						&								\\  
								&	14.8~$\pm$~1.2		&	28.2~$\pm$~2.5		&0.19~$\pm$~0.3&0.26&					& Average						&								\\ \hline
\multirow{5}{*}{\rotatebox{90}{Acetone}}	        	&	25.9~$\pm$~*		&	54.1				&	0.26		&*		&	10		&\cite{Weckman1996}				&$\dot{Q''}$ of 740~\si{kW/m^2}	\\
	        							&	18.7~$\pm$~11\%		&	38.1				&	0.27		&0.31		&	10		&\cite{Kim2019}					&								\\
	        							&	18.7~$\pm$~10\%		&	37.7				&	0.28		&*		&	5		&\cite{Buch1997}					&								\\ 
	        							&	17.6~$\pm$~15\%		&	35.5				&	*		&*		&	10		&This Study						&								\\ 
