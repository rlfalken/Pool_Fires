...
$Q^*$ is the normalized energetics of a fire and is defined as:
\begin{equation}
Q^*=\frac{\dot{Q}}{c_{p}\rho_\infty T_\infty \sqrt{g D} \, D^2}
\end{equation}
...
\begin{equation}
\label{eq:heat_release_rate_uncertainty}
u_{\scriptscriptstyle {Q^*}} \approx \frac{u_{\scriptscriptstyle \dot{Q}}}{c_{p}\rho_\infty T_\infty \sqrt{g D} \, D^2}
\end{equation}
